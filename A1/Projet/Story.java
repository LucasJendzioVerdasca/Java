public class Story {
    public static void printIntro() {
        ...
        GameLogic.anythingToContinue();
        System.out.println("Vous le retenez néanmoins parfaitement ainsi que la manière dont il faut pour s’y rendre « Poudlard, par le Poudlard Express voie 93/4 gare de King’s Cross .");
        GameLogic.anythingToContinue();
        ...
        GameLogic.printSeparator(30);
        System.out.println("C’est enfin le jour de la rentrée à Poudlard. Malgré quelques difficultés, vous trouvez la voie 93/4 grâce à une famille aux cheveux rouge flamme qui s’y rendait également. Cette famille venait pour leur fils qui avait d’ailleurs mon âge.");
        GameLogic.anythingToContinue();
