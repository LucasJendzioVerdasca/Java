...
public class Story {
        ...
        public static void FirstActOutro() {
                ...
                GameLogic.anythingToContinue();
                GameLogic.clearConsole();
                System.out.println("A la suite de cette brève discussion, je suis reparti vers ma salle commune. Au même moment, à l'angle du couloir, je commençais à entendre des bruits de pas et la voix des professeurs. Ces trois-là vont passer un sale quart d'heure !");
                GameLogic.anythingToContinue();
                GameLogic.clearConsole();
                ...
                System.out.println("Moi : - Cher parents.");
                GameLogic.anythingToContinue();
                System.out.println("L'année est bientôt terminée et j'ai hâte de vous retrouver pour tout vous raconter en détail. Nous avons nos examens de fin d'année dans deux semaines et grâce à mes révisions à la bibliothèque avec Hermione Granger, la fille dont je vous avais parlé dans ma lettre de Novembre, je me sens prêt.");
                GameLogic.anythingToContinue();
